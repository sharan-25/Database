...
--------------------------------------------------------
--  File created - Friday-December-08-2023   
--------------------------------------------------------
--------------------------------------------------------
...
Insert into SCHOOL_KAUR_2211871.REPORTS (REPORTID,STUDENTID,TEACHERID,RESULT,COMMENTS,CREATEDDATE,LASTMODIFIEDDATE,EXAM_DATE,COURSEID) values ('84CC274A580C432CBFA256A5A959C887','C106A56DFCB14305988EA8D3A2521AF9','7056DCDA9BF24C4592DC65900C9E476D',50,'PASS',to_timestamp('05-12-23 5:57:12.813000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),to_timestamp('05-12-23 5:57:12.813000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),to_date('03-12-23','DD-MM-RR'),null);
Insert into SCHOOL_KAUR_2211871.REPORTS (REPORTID,STUDENTID,TEACHERID,RESULT,COMMENTS,CREATEDDATE,LASTMODIFIEDDATE,EXAM_DATE,COURSEID) values ('9A0566A0BA5F4E299B4B48444C6E9EF2','C106A56DFCB14305988EA8D3A2521AF9','7056DCDA9BF24C4592DC65900C9E476D',50,'PASS',to_timestamp('05-12-23 5:57:12.813000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),to_timestamp('05-12-23 5:57:12.813000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),to_date('03-12-23','DD-MM-RR'),null);
...
SELECT COURSES.COURSENAME,MAX(RESULT) AS HIGHEST_MARKS INTO PARAM_NAME_OF_COURSE,PARAM_HIGHEST_MARKS
FROM REPORTS
...
RETURN VARCHAR2
AS
PARAM_STUDENTID_HIGHEST_AVERAGE VARCHAR2(32):= '';
BEGIN
--FOR LOWEST AVERAGE
 ...
 --FOR HIGHEST AVERAGE
  SELECT STUDENTID INTO PARAM_STUDENTID_HIGHEST_AVERAGE
  FROM REPORTS GROUP BY STUDENTID ORDER BY AVG(RESULT)DESC
  FETCH FIRST ROW ONLY;
  RETURN PARAM_STUDENTID_HIGHEST_AVERAGE;
...
BEGIN
    ...
    TIMESHEETS.CREATED_DATE_TIME, TIMESHEETS.LAST_MODIFIED_DATE,TEACHERS.TEACHERID AS TIMESHEETS_FK_TEACHERID, LASTNAME, FIRSTNAME, EMAIL, SALARY,
    ...
    each_row.EMAIL, each_row.SALARY, each_row.SOCIAL_INSURANCE_NUMBER,each_row.INSURANCE_RATE,each_row.PAYCHECK));
    END LOOP;
    RETURN;
